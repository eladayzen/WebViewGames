...
// Natural aspect (height / width) of raph_ride.png (388x511 -- new locked
// back-view skater pose, §"changing the character" plan), so the billboard
// doesn't stretch the art.
export const PLAYER_ASPECT = 511 / 388;
